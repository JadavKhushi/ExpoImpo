<%-- 
    Document   : Vegetables
    Created on : Jan 31, 2024, 10:54:43 a.m.
    Author     : ashu
--%>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card" style="width:30rem;">
                <img src="assets/potato.jpg" class="card-img-top" alt="Potato">
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card" style="width: 30rem;">
                <img src="assets/tomato3.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Tomato</h5>
                    <p class="card-text"><b>Products : </b>Green     <br>
                        <b>Size : </b> 30 mm, 50 mm, 55mm
                        <br> <b>Availability : </b> March, April, May
                    <br> <h4>About Tomato</h4>Hiral Overseas well known exporter of Onion to Sri Lanka, Malaysia and United Arab Emirates and is the largest exporter of Onion in the World.
                    </p>
                        <a href="viewOrders.jsp" class="btn btn-warning">Order Product</a>
                    </div>
            </div>
        ...
        <!-- End tomato -->
            ...
            <div class="col-md-6">
            <div class="card" style="width:30rem;">
                <img src="assets/onion2.jpg" class="card-img-top" alt="Red Onion">
                <div class="card-body">
                    <h5 class="card-title">Red Onion</h5>
                    <p class="card-text"><b>Size : </b> 30 mm to 50 mm && 50 mm to 60 mm
                        <br> <b>Packing : </b> 1 kg, 2 kg, 5 kg, 10 kg, 20 kg, Mesh Bag
                    <br> <h4>About Onion</h4>Hiral Overseas well known exporter of Onion to Sri Lanka, Malaysia and United Arab Emirates and is the largest exporter of Onion in the World.
                    </p>
        ...
        <div class="col-md-6">
            <div class="card" style="width: 30rem;">
                <img src="assets/onion1.jpg" class="card-img-top" alt="White Onion">
                <div class="card-body">
                    <h5 class="card-title">White Onion</h5>
                    <p class="card-text"><b>Size : </b> 30 mm to 50 mm && 50 mm to 60 mm
                        <br> <b>Packing : </b> 1 kg, 2 kg, 5 kg, 10 kg, 20 kg, Mesh Bag
                    <br> <h4>About Onion</h4>Hiral Overseas well known exporter of Onion to Sri Lanka, Malaysia and United Arab Emirates and is the largest exporter of Onion in the World.
                    </p>
        ...
        <div class="col-md-6">
            <div class="card" style="width:30rem;">
                <img src="assets/redchilly.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Red Chilly</h5>
                    <p class="card-text"><b>Products : </b>Green     <br>
                        <b>Size : </b> 30 mm, 50 mm, 55mm
                        <br> <b>Availability : </b> March, April, May
                    <br> <h4>About Tomato</h4>We exports Tomato to Maldives, United Arab Emirates and United States and all over the World.As per Volza’s India Export data, Tomato export shipments from India stood at 133.9K, exported by 4,877 India Exporters to 7,967 Buyers.
                    </p>
                    <a href="viewOrders.jsp" class="btn btn-warning">Order Product</a>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card" style="width: 30rem;">
                <img src="assets/chilli2.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Green Chilly</h5>
                    <p class="card-text"><b>Products : </b>Red     <br>
                        <b>Size : </b> 30 mm, 50 mm, 55mm
                        <br> <b>Availability : </b> March, April, May
                    <br> <h4>About Tomato</h4>We exports Tomato to Maldives, United Arab Emirates and United States and all over the World.As per Volza’s India Export data, Tomato export shipments from India stood at 133.9K, exported by 4,877 India Exporters to 7,967 Buyers.
                    </p>
